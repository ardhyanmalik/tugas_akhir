                                                ...
                                                <td>
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td class="free-text">
                                                                Hello {{$name}},
                                                                It looks like you requested a new password. You'll need the following link to actived it. If you didn't request a new password, please ignore this email. <br><br>
