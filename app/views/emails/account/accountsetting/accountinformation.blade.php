                                                ...
                                                <td>
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td class="free-text">
                                                                Hello, {{$name}}<br>
                                                                Your account information has been modified. If it's not you,make sure you can login into your account and
                                                                change your password immediately,but if you can't access your account let us know. Please feel free
                                                                to contact us by sending email to <strong>telkomuniversity@gmail.com</strong>
                                                            </td>
                                                        </tr><br>
                                                    </table>
                                                </td>
