                                                ...
                                                <td>
                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                        <tr>
                                                            <td class="free-text">
                                                                Hello, {{$name}}<br>
                                                                Administrator of <strong>Telkom University Store</strong> just created your account as <strong>Administrator</strong>.
                                                                Welcome to <strong>Telkom University Store</strong>, just one step more you're officially become new our <strong>Administrator</strong> .
                                                                Please hit button below for active your account!
                                                            </td>
                                                        </tr><br>
                                                        <tr>
                                                            <td class="button">
                                                                <div>
                                                                    <a class="button-mobile" href="{{$link}}" style="background-color:#4a89dc;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Active Account</a>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
