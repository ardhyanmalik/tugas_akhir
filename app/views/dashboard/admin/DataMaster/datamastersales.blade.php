            ...
            <section id="content" class="table-layout animated fadeIn">
                ...
                <div class="tray tray-center p10 va-t posr">
                    ...
                    <div class="pull-right mb5 mt5">
                        <a href="#modal-panel" class="modal-example-btn btn btn-lg btn-system"><i class="fa fa-plus"></i> Add Sales </a>
                    </div>

                    <div id="modal-panel" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title"><i class="fa fa-plus"></i>Add New Sales</span>
                            </div>
                            <!-- end .panel-heading section -->

                            <form method="post" action="{{URL::route('account-create-sales-post')}}" id="comment">
                            ...
                            <div class="panel panel-visible table-responsive" id="spy2">
                                <div class="panel-heading">
                                    <div class="panel-title hidden-xs">
                                        <span class="glyphicon glyphicon-user"></span>Data Master Sales</div>
                                </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover" id="datatable2" >
                                            ...
                                            @foreach($datasales as $datasaless)
                                                <tr>
                                                    <td>{{ $i }}</td>
                                                    <td>{{$datasaless->name}}</td>
                                                    <td>{{$datasaless->username}}</td>
                                                    <td>{{$datasaless->email}}</td>
                                                    <td>
                                                        <?php
                                                        if($datasaless->status_user==0){
                                                        echo "Not Active";
                                                        }else if($datasaless->status_user==1){
                                                        echo "Active";
                                                        }else{
                                                        echo "Banned";
                                                        }
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="#modal-edit" onclick="getEdit('{{$datasaless->name}}','{{$datasaless->username}}','{{$datasaless->email}}');" class="modal-example-btn btn btn-system" title="Edit User"><i class="fa fa-pencil"></i></a>
                                                            <a href="{{URL::route('account-banned-sales-post',$datasaless->id_user)}}" onclick="return confirm('Are you sure Banned this user?')" class="btn btn-warning" title="Ban User"><i class="fa fa-ban"></i></a>
                                                            <a href="{{URL::route('account-delete-sales-post',$datasaless->id_user)}}" onclick="return confirm('Are you sure Delete this user?')" class="btn btn-danger" title="Delete User"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php $i++;?>
                    ...
                    <div id="modal-edit" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title"><i class="fa fa-edit"></i>Edit Sales</span>
                            </div>
                            <!-- end .panel-heading section -->

                            <form action="{{URL::route('account-edit-administrator-post',$datasaless->id_user)}}" method="post"  id="comment">
                                <div class="panel-body p25">
                                    <div class="section row">
                                        <div class="col-md-12">
                                            <label for="name" class="field prepend-icon">
