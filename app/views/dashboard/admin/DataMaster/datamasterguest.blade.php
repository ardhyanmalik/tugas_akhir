        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="tray tray-center p10 va-t posr">
                ...
                <div class="pull-right mb5 mt5">
                    <a href="#modal-panel" class="modal-example-btn btn btn-lg btn-system"><i class="fa fa-plus"></i> Add Guest </a>
                </div>

                <div id="modal-panel" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-plus"></i>Add New Guest</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form action="{{URL::route('account-create-guest-post')}}" method="post">
                ...
                <div class="row">
                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="glyphicon glyphicon-user"></span>Data Master Guest</div>
                            </div>
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="datatable2" >
                                        ...
                                        <?php $i=1; ?>
                                        @foreach($dataguest as $dataguests)
                                        <tr>
                                            <td>{{ $i }}</td>
                                            <td>{{$dataguests->name}}</td>
                                            <td>{{$dataguests->username}}</td>
                                            <td>{{$dataguests->email}}</td>
                                            <td>
                                                <?php
                                                if($dataguests->status_user==0){
                                                    echo "Not Active";
                                                }else if($dataguests->status_user==1){
                                                    echo "Active";
                                                }else{
                                                    echo "Banned";
                                                }
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="#modal-editguest" onclick="getEdit('{{$dataguests->name}}','{{$dataguests->username}}','{{$dataguests->email}}');" class="modal-example-btn btn btn-system" title="Edit User"><i class="fa fa-pencil"></i></a>
                                                    <a href="{{URL::route('account-banned-guest-post',$dataguests->id_user)}}" onclick="return confirm('Are you sure Banned this user?')"class="btn btn-warning" title="Ban User"><i class="fa fa-ban"></i></a>
                                                    <a href="{{URL::route('account-delete-guest-post',$dataguests->id_user)}}" onclick="return confirm('Are you sure Delete this user?')"class="btn btn-danger" title="Delete User"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
                    ...
                    <div id="modal-editguest" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                        <div class="panel">
                            <div class="panel-heading">
                            ...
                            <form action="{{URL::route('account-edit-guest-post',$dataguests->id_user)}}" method="post"  id="comment">
                                <div class="panel-body p25">
                                    <div class="section row">
                                        <div class="col-md-12">
                                            <label for="name" class="field prepend-icon">
