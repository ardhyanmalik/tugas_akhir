        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Moderator</li>
                </ol>
            </div>
        ...
        <section id="content" class="table-layout animated fadeIn">
            ...
            <div class="tray tray-center p10 va-t posr">
                ...
                <div class="pull-right mb5 mt5">
                    <a href="#modal-panel" class="modal-example-btn btn btn-lg btn-system"><i class="fa fa-plus"></i> Add Moderator </a>
                </div>

                <div id="modal-panel" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-plus"></i>Add New Moderator</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form method="post" action="{{URL::route('account-create-moderator-post')}}" id="comment">
                            <div class="panel-body p25">
                                <div class="section row">
                                    <div class="col-md-12">
                                        <label for="firstname" class="field prepend-icon">
                                            <input type="text" name="name" id="name" class="gui-input" placeholder="Fullname...">
                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="glyphicon glyphicon-user"></span>Data Master Moderator</div>
                            </div>
                            <div class="panel-body pn">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="datatable2" >
                                        ...
                                        <?php $i=1; ?>
                                        @foreach($datamoderator as $datamoderators)
                                            <tr>
                                                <td>{{ $i }}</td>
                                                <td>{{$datamoderators->name}}</td>
                                                <td>{{$datamoderators->username}}</td>
                                                <td>{{$datamoderators->email}}</td>
                                                <td>
                                                    <?php
                                                    if($datamoderators->status_user==0){
                                                        echo "Not Active";
                                                    }else if($datamoderators->status_user==1){
                                                        echo "Active";
                                                    }else{
                                                        echo "Banned";
                                                    }
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="#modal-editmoderator" onclick="getEdit('{{$datamoderators->name}}','{{$datamoderators->username}}','{{$datamoderators->email}}');" class="modal-example-btn btn btn-system" title="Edit User"><i class="fa fa-pencil"></i></a>
                                                        <a href="{{URL::route('account-banned-moderator-post',$datamoderators->id_user)}}" onclick="return confirm('Are you sure Banned this user?')" class="btn btn-warning" title="Ban User"><i class="fa fa-ban"></i></a>
                                                        <a href="{{URL::route('account-delete-moderator-post',$datamoderators->id_user)}}" onclick="return confirm('Are you sure Delete this user?')" class="btn btn-danger" title="Delete User"><i class="fa fa-trash"></i></a>
                                                    </div>
                ...
                <div id="modal-editmoderator" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                        <div class="panel">
                            <div class="panel-heading">
                                <span class="panel-title"><i class="fa fa-edit"></i>Edit Moderator</span>
                            </div>
                            <!-- end .panel-heading section -->

                            <form action="{{URL::route('account-edit-moderator-post',$datamoderators->id_user)}}" method="post"  id="comment">
                                <div class="panel-body p25">
                                    <div class="section row">
                                        <div class="col-md-12">
...
<script>
        function getEdit(name,username,email) {
