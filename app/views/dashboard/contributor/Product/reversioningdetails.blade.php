                                                ...
                                                <div class="section">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 input-group mt10">
                                                                 <a href="{{URL::route('reversioning-file',$items->produk_link)}}" target="_blank">Download File</a>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt15">
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <a href="{{URL::route('dashboard-contributor-manageproduct-reversioning-status')}}" class="btn btn-system center-block">
