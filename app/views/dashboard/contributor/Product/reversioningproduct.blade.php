            ...
            <div class="tray tray-center p5 va-t posr">
                ...
                <div class="panel mb5 mt5">
                    ...
                    <div class="panel-body p20 pb10">
                        ...
                        {{Form::open(array('route'=>array('dashboard-contributor-manageproduct-postreversioning',Auth::user()->id_user),'files'=>true))}}
...
<script>
    $(function()
    {
        $( "#product_title" ).autocomplete({
            source: "/dashboard-contributor/manage-product/reversioning/search",
            minLength: 1,
