                    ...
                    <aside class="tray tray-left pn va-t tray250" data-tray-height="match">
                        ...
                        <div class="p10">
                            ...
                            <ul class="nav nav-messages p5" role="menu">
                                <li class="active">
                                        <a href="{{URL::route('dashboard-payment-messages-compose')}}" class="text-dark fw600 p8 animated animated-short fadeInDown">
                                            <span class="fa fa-envelope pr5"></span> Compose Message
                                        </a>
                                    </li>
                                <li class="">
                                    <a href="{{URL::route('dashboard-payment-messages-inbox')}}" class="text-dark fw600 p8 animated animated-short fadeInDown">
                                        <span class="fa fa-envelope pr5"></span> Inbox
                                        <span class="pull-right lh20 h-20 label label-warning label-sm">12</span>
                                    </a>
                                </li>
                                <li class="">
                                    <a href="{{URL::route('dashboard-payment-messages-sendbox')}}" class="text-dark fw600 p8 animated animated-short fadeInDown">
                    ...
                    <div class="tray tray-center pn va-t bg-light">
                        ...
                        <div class="admin-form tab-pane" id="register2" role="tabpanel">
                            <div class="panel panel-danger heading-border">
                                ...
                                <form method="post" action="{{URL::route('messages-payment-create')}}" id="messages">                                
