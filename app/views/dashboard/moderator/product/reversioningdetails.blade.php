                    ...
                    <div class="admin-form">
                        <div id="p1" class="panel heading-border">
                            <div class="panel-body bg-light">
                                                ...
                                                @foreach($owner as $ownerinfo)
                                                    @if($ownerinfo->role_id==3)
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-12 col-md-8 col-lg-8 input-group">
                                                                ...
                                                                <input name="name" class="form-control" type="text"  value="{{$ownerinfo->id_contributor}}"placeholder="Full Name" readonly>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-8 col-lg-8 input-group">
                                                            ...
                                                            <input name="name" class="form-control" type="text"  value="{{$ownerinfo->name}}"placeholder="Full Name" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-8 input-group">
                                                            ...
                                                            <input name="email" class="form-control" type="text" value="{{$ownerinfo->email}}"placeholder="Email" readonly>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                ...
                                <div class="section-divider mb40" id="spy1">
                                    <span>User Reversioning Informations</span>
                                </div>
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                            <div class="section">
                                                @foreach($offer as $offerinfo)
                                                    @if($offerinfo->role_id==3)
                                                        <div class="form-group">
                                                            <label class="col-sm-12 col-md-4 col-lg-4 control-label text-right">NIK/NIM</label>
                                                            <div class="col-sm-12 col-md-8 col-lg-8 input-group">
                                                                <span class="input-group-addon"><i class="fa fa-font"></i>
                                                                </span>
                                                                <input name="name" class="form-control" type="text"  value="{{$offerinfo->id_contributor}}"placeholder="Full Name" readonly>
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-8 col-lg-8 input-group">
                                                            ...
                                                            <input name="name" class="form-control" type="text"  value="{{$offerinfo->name}}"placeholder="Full Name" readonly>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-8 input-group">
                                                            ...
                                                            <input name="email" class="form-control" type="text" value="{{$offerinfo->email}}"placeholder="Email" readonly>
                                                        </div>
                                                    </div>
                                                @endforeach
                                            </div>
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8 input-group">
                                                            ...
                                                            <input class="form-control" type="text" placeholder="Youtube Link" value="{{$items->produk_video_youtube}}">
                                                        </div>
                                                    </div>

                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label text-right">Product Version</label>
                                                        <div class="col-md-8 input-group">
                                                                <span class="input-group-addon"><i class="fa fa-sort"></i>
                                                                </span>
                                                            <input id="spinner3" class="form-control ui-spinner-input" name="spinner" value="{{$items->produk_version}}" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-md-4 control-label text-right">Product's File</label>
                                                        <div class="col-md-8 input-group mt10">
                                                            <a href="{{URL::route('moderator-reversioning-file',$items->produk_link)}}" target="_blank">Download File</a>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mt15">
                                        <div class="btn-group pull-right">
                                                ...
                                                <a href="{{URL::route('dashboard-moderator-manageproduct-reversioning')}}" class="btn btn-system center-block">
                                                    <i class="fa fa-arrow-left"></i>
                                                    Back to List
                                                </a>

                                                <a href="" class="btn btn-system dark center-block">
