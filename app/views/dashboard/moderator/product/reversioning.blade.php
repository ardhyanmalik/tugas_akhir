                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="fa fa-refresh"></span>Reversioning Product</div>
                            </div>
                                        ...
                                        @foreach($reversioning as $data)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        @if($data->reversioning_produk_status==2)
                                                            <a href="{{URL::route('dashboard-moderator-manageproduct-reversioning-details',$data->id_reversioning)}}" class="btn btn-info" title="Details"><i class="fa fa-info-circle"></i></a>
                                                        @endif
                                                        @if($data->reversioning_produk_status==3)
                                                            <a href="{{URL::route('dashboard-moderator-manageproduct-reversioning-approve',$data->id_reversioning)}}" onclick="return confirm('Are you sure approve this reversioning ?')"  class="btn btn-system" title="Deny"><i class="fa fa-check-circle"></i></a>
                                                            <a href="{{URL::route('dashboard-moderator-manageproduct-reversioning-deny',$data->id_reversioning)}}" onclick="return confirm('Are you sure deny this reversioning ?')"  class="btn btn-danger" title="Deny"><i class="fa fa-ban"></i></a>
                                                            <a href="{{URL::route('dashboard-moderator-manageproduct-reversioning-details',$data->id_reversioning)}}" class="btn btn-info" title="Details"><i class="fa fa-info-circle"></i></a>
                                                        @endif
                                                    </div>
                                                </td>
