        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Product Approval</li>
                </ol>
            </div>
                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="fa fa-check-circle"></span>Product Approval</div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="datatable2" >
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$product->id_contributor}}</td>
                                            <td>{{$product->produk_type}}</td>
                                            <td>{{$product->created_at}}</td>
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{URL::route('dashboard-moderator-manageproduct-approve',$product->id_produk_detail)}}" onclick="return confirm('Are you sure approve this product?')" class="btn btn-system" title="Approve"><i class="fa fa-check-circle"></i></a>
                                                    <a href="{{URL::route('dashboard-moderator-manageproduct-denied',$product->id_produk_detail)}}" onclick="return confirm('Are you sure deny this product?')" class="btn btn-danger" title="Deny"><i class="fa fa-ban"></i></a>
                                                    <a href="{{URL::route('dashboard-moderator-manageproduct-needapproval-details',$product->id_produk_detail)}}" class="btn btn-info" title="Details"><i class="fa fa-info-circle"></i></a>
                                                </div>
                                            </td>
                                        </tr>
                                        <?php $i++;?>
