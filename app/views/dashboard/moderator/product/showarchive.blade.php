                    ...
                    <div class="admin-form">
                        <div id="p1" class="panel heading-border">
                            <div class="panel-body bg-light">
                                ...
                                @foreach($userhistory as $offerinfo)
                                <div class="section-divider mb40" id="spy1">
                                            ...
                                            <div class="section">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-12 col-md-8 col-lg-8 input-group">
                                                            ...
                                                            <input name="name" class="form-control" type="text"  value="{{$offerinfo->reversionoffer}}"placeholder="Full Name" readonly>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt15">
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <a href="{{URL::route('dashboard-moderator-manageproduct-product-archive',$items->id_produk)}}" class="btn btn-system center-block">
