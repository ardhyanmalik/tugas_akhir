            ...
            <div class="tray tray-center p10 va-t posr">
                ...
                <div id="modal-addcategory" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                    <div class="panel">
                        <div class="panel-heading">
                            <span class="panel-title"><i class="fa fa-plus"></i>Add Product Category</span>
                        </div>
                        <!-- end .panel-heading section -->

                        <form action="{{URL::route('dashboard-moderator-content-categories-addcategory')}}" method="post"  id="category_name">
                                ...
                                <div class="section row">
                                    <div class="col-md-12 ">
                                        <label for="category" class="field prepend-icon">
                                            <input type="text" name="category_name" id="category_name" class="gui-input" placeholder="Category Name">
                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="fa fa-tags"></span>Product Categories</div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover" id="datatable2" >
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{URL::route('dashboard-moderator-content-categories-details',$categories->id_category)}}" class="btn btn-info" title="Details"><i class="fa fa-info-circle"></i></a>
                                                    <a href="#modal-editcategory" onclick="getEdit('{{$categories->category_name}}');" class="modal-example-btn btn btn-system" title="Edit Category"><i class="fa fa-pencil"></i></a>
                                                        ...
                                                        <a href="{{URL::route('dashboard-moderator-content-categories-deletecategory-parent',$categories->id_category)}}" onclick="return confirm('Are you sure Delete this category? If this category has sub-category, system will delete also sub-category.')" class="btn btn-danger"  onclick="return confirm('Are you sure Delete this category?')" title="Delete Category"><i class="fa fa-trash"></i></a>
                ...
                <div id="modal-editcategory" class=" popup-basic admin-form mfp-with-anim mfp-hide">
                    <div class="panel">
                        ...
                        <form  action="{{URL::route('dashboard-moderator-content-categories-updatecategory',$categories->id_category)}}" method="post" id="editcategory">
                            <div class="panel-body p25">
                                <div class="section row">
                                    <div class="col-md-12 ">
                                        <label class="field select prepend-icon">
