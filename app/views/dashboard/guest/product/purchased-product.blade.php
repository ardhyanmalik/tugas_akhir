        ...
        <header id="topbar">
            <div class="topbar-left">
                <ol class="breadcrumb">
                    ...
                    <li class="crumb-trail">Purchase Product</li>
                </ol>
            </div>
                        ...
                        <div class="panel panel-visible table-responsive" id="spy2">
                            <div class="panel-heading">
                                <div class="panel-title hidden-xs">
                                    <span class="fa fa-check-circle"></span>Purchased Product</div>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            @foreach($orderproduct as $order)
                                                <tr>
                                                    ...
                                                    <?php
                                                        if($order->status==0){
                                                            echo "<span class='label label-warning'>Waiting Sales</span>";
                                                        }elseif ($order->status==1) {
                                                            echo "<span class='label label-warning'>Approved by Sales</span>";
                                                        }elseif ($order->status==2){
                                                            echo "<span class='label label-warning'>Need Confirm Payment</span>";
                                                        }elseif ($order->status==3){
                                                            echo "<span class='label label-system'>Purchased</span>";
                                                        }
                                                    ?>
                                                    </td>
                                                    <td>
