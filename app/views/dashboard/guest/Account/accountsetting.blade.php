                ...
                <div class="fileupload fileupload-new admin-form mt20" data-provides="fileupload">
                    ...
                    <div class="row">
                        <div class="col-xs-4 col-md-12 center-block">
                            {{Form::open(array('route'=>array('guest-account-setting-update-profpict',Auth::user()->id_user),'files'=>true))}}
                    ...
                    <div class="admin-form">
                        <div id="p1" class="panel heading-border">
                            <div class="panel-body bg-light">
                                ...
                                <div class="row">
                                    <form action="{{URL::route('guest-account-setting-update-accouninfo',Auth::user()->id_user)}}" method="post">
                                                ...
                                                <div class="section">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <span class="input-group-addon"><i class="fa fa-user"></i>
                                                            ...
                                                            <input name="username" class="form-control" type="text" value="{{Auth::user()->username}}"placeholder="Username">
                                                        </div>
                                                    </div>
                                                    @endif
                                                    @if(Auth::user()->username!=null)
                                ...
                                <div class="row">
                                    <form action="{{URL::route('guest-account-setting-update-changepassword',Auth::user()->id_user)}}" method="post">
                                        <div class="form-horizontal" role="form">
                                            <div class="col-md-10 ">
                                ...
                                <div class="row">
                                    <form action="{{URL::route('guest-account-setting-update-socialinfo',Auth::user()->id_user)}}" method="post">
                                        <div class="form-horizontal" role="form">
                                            <div class="col-md-10 ">
                                                <div class="section">
                                                    <div class="form-group">
